...
const COLOR_MODES = [
    {
        ...
        label: 'Normal',
        description: 'Default',
        swatch: 'linear-gradient(135deg, #e74c3c 33%, #2ecc71 33% 66%, #3498db 66%)',
    },
    {
        id: 'protanopia',
        label: 'Protanopia',
        description: 'Red-blind',
        swatch: 'linear-gradient(135deg, #8a8a00 33%, #d4d400 33% 66%, #3498db 66%)',
    },
    {
        id: 'deuteranopia',
        label: 'Deuteranopia',
        description: 'Green-blind',
        swatch: 'linear-gradient(135deg, #c8a000 33%, #9a9a00 33% 66%, #3498db 66%)',
    },
    {
        id: 'tritanopia',
        label: 'Tritanopia',
        description: 'Blue-yellow',
        swatch: 'linear-gradient(135deg, #e74c3c 33%, #2ecc71 33% 66%, #c0c0c0 66%)',
    },
    {
        id: 'grayscale',
        label: 'Grayscale',
        description: 'No colour',
        swatch: 'linear-gradient(135deg, #555 33%, #999 33% 66%, #ddd 66%)',
    },
    {
        id: 'high-contrast',
        label: 'High Contrast',
        description: 'Max visibility',
...
function applyColorMode(id) {
    document.body.classList.remove(
        'cb-protanopia', 'cb-deuteranopia', 'cb-tritanopia', 'cb-grayscale', 'cb-high-contrast'
    );
    if (id !== 'normal') {
        document.body.classList.add(`cb-${id}`);
    }
}
            ...
            <div style={{ position: 'fixed', bottom: 24, right: 24, zIndex: 9999, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 12 }}>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                <Accessibility size={16} color="var(--text-primary)" />
                        ...
                        <div style={{ padding: '20px 20px 16px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
                                <Type size={13} color="var(--text-tertiary)" />
                                    ...
                                    return (
                                        <button
                                            ...
                                            style={{
                                                ...
                                                padding: '10px 4px',
                                                borderRadius: 10,
                                                border: active ? '1.5px solid var(--text-primary)' : '1px solid var(--border-subtle)',
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
                                {ZOOM_LEVELS.map(level => (
                                    <span key={level.id} style={{ flex: 1, textAlign: 'center', fontSize: 10, color: 'var(--text-tertiary)' }}>
                                        {level.title}
                                    </span>
                                ))}
                            </div>
                        ...
                        {/* Divider */}
                        <div style={{ height: 1, backgroundColor: 'var(--border-subtle)', margin: '0 20px' }} />

                        {/* Colour Vision Section */}
                        <div style={{ padding: '16px 20px 20px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
                                <Eye size={13} color="var(--text-tertiary)" />
                                <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                                    Colour Vision
                                </span>
                            </div>
                        ...
                        <div style={{ padding: '0 20px 16px', display: 'flex', justifyContent: 'center' }}>
                            <button
                                onClick={() => { handleZoom('normal'); handleColorMode('normal'); }}
                                style={{
                                    fontSize: 12,
                ...
                <button
                    ...
                    style={{
                        ...
                        height: 52,
                        borderRadius: '50%',
                        backgroundColor: open ? 'var(--text-secondary)' : 'var(--text-primary)',
